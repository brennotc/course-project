...
export class AuthService {
  ...
  login(email: string, password: string) {
    return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCep9PeeJQNEhJa26flcpr5GqkVcBtFOgg',
    {
      email: email,
      password: password,
      returnSecureToken: true
